...
ESS05$cntry<- as.factor(ESS05$cntry)
summary(ESS05$cntry)
...
ESS05$AGE6cat <- ifelse(ESS05$agea < 25,
                        "14-24",
                        ifelse(ESS05$agea < 35,
                               "25-34",
                               ifelse(ESS05$agea < 45,
                                      "35-44",
                                      ifelse(ESS05$agea < 55,
                                             "45-54",
                                             ifelse(ESS05$agea < 65,
                                                    "55-64",
                                                    ifelse(ESS05$agea < 75,
                                                           "65-74",
                                                           "75+"))))
...
ESS05$AGE6cat <- factor(ESS05$AGE6cat, ordered = TRUE)

summary(ESS05$AGE6cat)

# 5. recode level of education
summary(ESS05$edulvlb)
...
summary(ESS05$EDUCATION)
ESS05$EDUCATION <- factor(ESS05$EDUCATION, ordered = TRUE)


# 6. Recoding occupation 
summary(ESS05$iscoco)
