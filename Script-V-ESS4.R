...
ESS04$cntry<- as.factor(ESS04$cntry)
summary(ESS04$cntry)
...
ESS04$AGE6cat <- ifelse(ESS04$agea < 25,
                        "14-24",
                        ifelse(ESS04$agea < 35,
                               "25-34",
                               ifelse(ESS04$agea < 45,
                                      "35-44",
                                      ifelse(ESS04$agea < 55,
                                             "45-54",
                                             ifelse(ESS04$agea < 65,
                                                    "55-64",
                                                    ifelse(ESS04$agea < 75,
                                                           "65-74",
                                                           "75+"))))
...
ESS04$AGE6cat <- factor(ESS04$AGE6cat, ordered = TRUE)

summary(ESS04$AGE6cat)

# 5. recode level of education
summary(ESS04$edulvla)
...
library(rio)
export(ESS04, "ESS04 Recoded.dta")
